...
public class Activity31 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final android.widget.Button btn = (android.widget.Button) findViewById(R.id.button74);
...

        {
            ...
            public void onClick(android.view.View vv) {
                EditText txt = (EditText) findViewById(R.id.editText29);
                String name = txt.getText().toString();
                boolean bl = name.equals("Laika");
                if (bl) {
                    Toast.makeText(Activity31.this, "correct!",
                            Toast.LENGTH_LONG).show();
                    btn.setClickable(false);
                    count++;
                } else
                    Toast.makeText(Activity31.this, "wrong!",
                            Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onclick6(View vv){
        Intent intent=new Intent(this, com.ce17b023.quizdo.Activity32.class);
