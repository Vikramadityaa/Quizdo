...
public class Activity43 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final android.widget.Button btn = (android.widget.Button) findViewById(R.id.button107);
...

        {
            ...
            public void onClick(android.view.View vv) {
                EditText txt = (EditText) findViewById(R.id.editText40);
                String name = txt.getText().toString();
                boolean bl = name.equals("Kanchenjunga");
                if (bl) {
                    Toast.makeText(Activity43.this, "correct!",
                            Toast.LENGTH_LONG).show();
                    btn.setClickable(false);
                    count++;
                } else
                    Toast.makeText(Activity43.this, "wrong!",
                            Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onclick6(View vv){
        Intent intent=new Intent(this, com.ce17b023.quizdo.ACtivity44.class);
