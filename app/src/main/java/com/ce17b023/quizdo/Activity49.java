...
public class Activity49 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final android.widget.Button btn = (android.widget.Button) findViewById(R.id.button122);
...

        {
            ...
            public void onClick(android.view.View vv) {
                EditText txt = (EditText) findViewById(R.id.editText45);
                String name = txt.getText().toString();
                boolean bl = name.equals("Andhra Pradesh");
                if (bl) {
                    Toast.makeText(Activity49.this, "correct!",
                            Toast.LENGTH_LONG).show();
                    btn.setClickable(false);
                    count++;
                } else
                    Toast.makeText(Activity49.this, "wrong!",
                            Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onclick6(View vv){
        Intent intent=new Intent(this, com.ce17b023.quizdo.Activity50.class);
