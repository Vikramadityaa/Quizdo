...
public class Activity51 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final android.widget.Button btn = (android.widget.Button) findViewById(R.id.button128);
...

        {
            ...
            public void onClick(android.view.View vv) {
                EditText txt = (EditText) findViewById(R.id.editText47);
                String name = txt.getText().toString();
                boolean bl = name.equals("Assam");
                if (bl) {
                    Toast.makeText(Activity51.this, "correct!",
                            Toast.LENGTH_LONG).show();
                    btn.setClickable(false);
                    count++;
                } else
                    Toast.makeText(Activity51.this, "wrong!",
                            Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onclick6(View vv){
        Intent intent=new Intent(this, com.ce17b023.quizdo.Activity52.class);
